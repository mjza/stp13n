sap.ui.define([
	"sap/ui/test/Opa5",
	"com/mjzsoft/smp13n/com0mjzsoft0smp13n/localService/mockserver",
	"sap/ui/model/odata/v2/ODataModel",
	"sap/ui/core/routing/HashChanger",
	"com/mjzsoft/smp13n/com0mjzsoft0smp13n/test/flpSandbox",
	"sap/ui/fl/FakeLrepConnectorLocalStorage"
], function(Opa5, mockserver, ODataModel, HashChanger, flpSandbox, FakeLrepConnectorLocalStorage) {
	"use strict";

	return Opa5.extend("com.mjzsoft.smp13n.com0mjzsoft0smp13n.test.integration.arrangements.Startup", {
		...
		iRestartTheAppWithTheRememberedItem : function (oOptions) {
			...
			this.waitFor({
				success : function() {
					oOptions.hash = "MeldungenSet/" + sObjectId;
