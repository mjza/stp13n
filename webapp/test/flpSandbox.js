		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "Reporting of damage and defects",
									"targetURL": "#Reportingofdamageanddefects-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"Reportingofdamageanddefects-display": {
								"semanticObject": "Reportingofdamageanddefects",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=com.mjzsoft.smp13n.com0mjzsoft0smp13n",
									"url": sap.ui.require.toUrl("com/mjzsoft/smp13n/com0mjzsoft0smp13n")
								}
							}
						}
					}
